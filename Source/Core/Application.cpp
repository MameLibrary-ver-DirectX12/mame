...
void Application::Render()
{
    ...
    postProcess_->ActivateSceneBuffer(commandList);     // Sceneの書き込み先を指定
    SceneManager::Instance().Render(commandList);       // Sceneの描画
    postProcess_->DeactivateSceneBuffer(commandList);   // 後処理など
